...
public interface MatchDAO {
         ...
         * @throws SQLException En cas d'erreur de base de données
         */
        public abstract Long createMatch(Date matchDate, int tournamentId) throws SQLException;
         ...
         * @throws SQLException En cas d'erreur de base de données ou de rollback de
         *                      transaction
         */
        public abstract Match createCompleteMatch(Team team1, Team team2, LocalDate matchDate, int gameId,
         ...
         * @throws SQLException En cas d'erreur de base de données
         */
        public abstract boolean updateMatchStatus(Long matchId, ry.ms.businessLogic.match.models.MatchStatus status)
                        throws SQLException;
         ...
         * @throws SQLException En cas d'erreur de base de données
         */
        public abstract List<Match> getMatchesByTournament(int tournamentId) throws SQLException;
